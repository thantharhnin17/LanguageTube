                        ...
                        <form method="POST" action="{{route('language.update',$language->id)}}" enctype="multipart/form-data" class="edit-profile m-b30">
                            ...
                            <div class="row wi-body">
                                <div class="form-group col-12">
                                    ...
                                    <div>
                                        <input name="language_name" class="form-control" type="text" value="{{$language->language_name}}">
                                    </div>
                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input name="level_name[]" class="form-control" type="text" value="{{$level->level_name}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
